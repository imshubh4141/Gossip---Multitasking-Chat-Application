...
<div id="modules" class="modules">
  ...
  <div class="item1" onMouseOut="pause1()" onMouseOver="play1()"><a class="mod" href="chat.php"><br><span>Gossip</span><br><br><video id="v1" width="400" height="240"><source src="gossip - video.mp4" type="video/mp4"></video></a>
  </div>
  ...
  <div class="item5" onMouseOut="pause5()" onMouseOver="play5()"><a href="maps.php"><br><span>Google Maps</span><br><br><video id="v5" width="400" height="240"><source src="Google Maps_ Theres More to Explore_ZG4JQX4BO9A_1080p.mp4" type="video/mp4"></video></a>
  </div>
  <div class="item6" onMouseOut="pause6()" onMouseOver="play6()"><a href="saavn.php"><br><span>Jio Saavn</span><br><br><video id="v6" width="400" height="240"><source src="Say hello to JioSaavn_Ee2_gdnpTtU_1080p.mp4" type="video/mp4"></video></a>
  </div>
</div>
<div id="ab"></div>
<br>
