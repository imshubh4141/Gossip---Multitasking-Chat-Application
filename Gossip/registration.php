...
<center><div class="login_form">
  <section class="login-wrapper">
    ...
    <form id="reg" class="reg" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
      ...
      <input  required name="firstname" type="text" id="firstname" onBlur="first()" maxlength="20" autocapitalize="off" autocorrect="off"/>
	  <label for="lastname">Last Name*</label>
      <input  required name="lastname" type="text" id="lastname" onBlur="last()" maxlength="20" autocapitalize="off" autocorrect="off"/>
      ...
      <input  required name="phone" type="number" id="number" maxlength="10" onBlur="mob()"/>
	  <label for="age">Age*</label>
      <input  required name="age" id="age" type="number" onBlur="ag()"/>
	  <div id="ag"></div>
	  ...
	  <br>
	  <p>* Required</p>
	  <p><a href="login.php" id="log">Login</a></p>
	  <button class="sub" id="sub" name="sub" type="submit">Sign Up</button>
    </form>
</section>
</div></center>
</body>
